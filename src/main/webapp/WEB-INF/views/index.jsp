...
<div class="container-scroller">
	...
	<nav class="sidebar sidebar-offcanvas" id="sidebar">
		<div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
			<a class="sidebar-brand brand-logo" href="index.html"><h1 style="color:aliceblue;">VOICE</h1></a>
			<a class="sidebar-brand brand-logo-mini" href="index.html"><h1 style="color:aliceblue;">V</h1></a>
		</div>
		<ul class="nav">
			...
			<li class="nav-item menu-items">
              ...
              <span class="menu-icon">
                <i class="mdi mdi-laptop"></i>
					...
					<span class="menu-title">음성분석</span>
			...
			<li class="nav-item menu-items">
              ...
              <span class="menu-icon">
                <i class="mdi mdi-playlist-play"></i>
					...
					<span class="menu-title">음성분석 결과</span>
				</a>
			</li>
			<li class="nav-item menu-items">
